...
import numpy as np
import math
#from robot_arm_realsense.robotiq_gripper import RobotiqGripper
from robot_arm_realsense.realsenseD435i import Camera


class UR_Robot:
    def __init__(self, tcp_host_ip="192.168.1.51", tcp_port=30003, workspace_limits=None,
